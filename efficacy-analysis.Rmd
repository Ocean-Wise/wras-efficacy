...
We now have our cleaned WRAS alert data, matched with vessel data. An additional step that **could** be done is filtering skipper by WRAS user. I don't think this is adviseable currently as the list doesn't seem to be up to date, for now I will filter OW staff off the list and see what we're left with. 

```{r}
users_clean %>% dplyr::filter(organization == "ow")
