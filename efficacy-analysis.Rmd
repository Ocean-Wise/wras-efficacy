...
Looks like there are vessels outside of ports and harbors which may slow to speeds of less than 4 knots, if I take it down to less than 2 knots we have `print(diff_in_datasets)` less records totaling `nrow(less_2)`, nearly 10% of the data.
